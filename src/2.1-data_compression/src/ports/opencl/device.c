...
{	
    ...
    compression_data->halved_samples = new cl::Buffer(*compression_data->context,CL_MEM_READ_WRITE , sizeof(unsigned int) * compression_data->j_blocksize/2 *  NUMBER_STREAMS);
    ...
    for(int step = 0; step < compression_data->steps; ++step)
    {
        ...
        {   
            cl::Kernel kernel_prepro=cl::Kernel(*compression_data->program,"process_input_preprocessor");
                        ...
                        kernel_prepro.setArg(2, *compression_data->zero_block_list);
                        kernel_prepro.setArg(3, *compression_data->zero_block_list_inverse);
                        kernel_prepro.setArg(4, compression_data->j_blocksize);
                        kernel_prepro.setArg(5, compression_data->r_samplesInterval);
                        kernel_prepro.setArg(6, compression_data->n_bits);
                        kernel_prepro.setArg(7, (unsigned int)(pow( 2,compression_data->n_bits) - 1));
                        kernel_prepro.setArg(8, offset_input_data_internal);
                        kernel_prepro.setArg(9, offset_input_data_post_process);
                        kernel_prepro.setArg(10, offset_zero_block_list);
        ...
        else
        {
            cl::Kernel kernel_no_prepro=cl::Kernel(*compression_data->program,"process_input_no_preprocessor");
                        ...
                        kernel_no_prepro.setArg(2, *compression_data->zero_block_list);
                        kernel_no_prepro.setArg(3, *compression_data->zero_block_list_inverse);
                        kernel_no_prepro.setArg(4, compression_data->j_blocksize);
                        kernel_no_prepro.setArg(5, compression_data->r_samplesInterval);
                        kernel_no_prepro.setArg(6, offset_input_data_internal);
                        kernel_no_prepro.setArg(7, offset_input_data_post_process);
                        kernel_no_prepro.setArg(8, offset_zero_block_list);
        ...
        cl::Kernel kernel_nocompression=cl::Kernel(*compression_data->program,"adaptative_entropy_encoder_no_compresion");
                    ...
                    kernel_nocompression.setArg(1, *compression_data->zero_block_list);
        ...
        unsigned int offset_halved_samples = ((compression_data->j_blocksize)/2 * (step % NUMBER_STREAMS));
        ...
        cl::Kernel kernel_second=cl::Kernel(*compression_data->program,"adaptative_entropy_encoder_second_extension");
                    ...
                    kernel_second.setArg(1, *compression_data->zero_block_list);
                    kernel_second.setArg(2, *compression_data->data_in_blocks);
                    kernel_second.setArg(3, *compression_data->size_block);
                    kernel_second.setArg(4, *compression_data->halved_samples);
                    kernel_second.setArg(5, *compression_data->compresion_identifier);
                    kernel_second.setArg(6, *compression_data->compresion_identifier_internal);
                    kernel_second.setArg(7, 1);
                    kernel_second.setArg(8, compression_data->j_blocksize);
                    kernel_second.setArg(9, compression_data->r_samplesInterval);
                    kernel_second.setArg(10, compression_data->n_bits);
                    kernel_second.setArg(11, offset_input_data_post_process);
                    kernel_second.setArg(12, offset_zero_block_list);
                    kernel_second.setArg(13, offset_data_in_blocks);
                    kernel_second.setArg(14, offset_size_block);
                    kernel_second.setArg(15, offset_halved_samples);
                    kernel_second.setArg(16, offset_compresion_identifier);
        ...
        for (unsigned int bit = 0; bit < compression_data->n_bits; ++ bit)
        {
            ...
            cl::Kernel kernel_sample=cl::Kernel(*compression_data->program,"adaptative_entropy_encoder_sample_spliting");
                        ...
                        kernel_sample.setArg(1, *compression_data->zero_block_list);
        ...
        */
        ...
        cl::Kernel kernel_blockselector=cl::Kernel(*compression_data->program,"adaptative_entropy_encoder_block_selector");
                        kernel_blockselector.setArg(0, *compression_data->zero_block_list);
	...
	)
{
    ...
    delete compression_data->halved_samples;
