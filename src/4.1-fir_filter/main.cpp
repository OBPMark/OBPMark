...
int main(int argc, char *argv[])
{
	...
	// init memory
	device_memory_init(conv_benck, size , size_B , size_k);
	// copy memory to device
	copy_memory_to_device(conv_benck, A, kernel, size , size_k);
	// execute kernel
	execute_kernel(conv_benck, size_B, size, size_B, kernel_size);
	// copy memory to host
